...
///////////////////////////////////////////////////////////////////////////////////////////////////
BOOL MBIsIOS7(){
    return ([[[[UIDevice currentDevice] systemVersion] substringToIndex:1] intValue] >= 7);
}
...
void MBHUD(NSString *message, float time){
    [MBProgressHUD showHUDViewTo:[[[[UIApplication sharedApplication] keyWindow] rootViewController] view]
                           image:nil
                            text:message
                    timeInterval:time];
}