...
@interface AppUploadCarCardViewController ()<UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    MBTextField *_nameTF;
    MBTextField *_cardTF;
    UIButton*_showBtn;
...
@implementation AppUploadCarCardViewController
...
- (void)viewDidLoad
{
    ...
    _itemIDNamelTiem.text = @"发证时间: ";
    [imageView addSubview:_itemIDNamelTiem];
    

    
    _timeSele =[[MBSelectView alloc]initWithFrame:CGRectMake(70, 103, kScreenHeight-250, 30)];
    _timeSele.selectType = MBSelectTypeDate;
    _timeSele.backgroundColor =[UIColor whiteColor];
