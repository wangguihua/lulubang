...
@interface AppUploadIDCardViewController ()<UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    MBTextField *_nameTF;
    MBTextField *_cardTF;
    UIButton*_showBtn;
...
@implementation AppUploadIDCardViewController
...
- (void)viewDidLoad
{
    ...
    UIImageView *imageView =[[UIImageView alloc]initWithFrame:CGRectMake(10, 10, kScreenWidth-20, 160)];
    ...
    UILabel*_itemIDNamelImage  =[[UILabel alloc]initWithFrame:CGRectMake(10, 110, 80, 30)];
    _itemIDNamelImage.backgroundColor =[UIColor clearColor];
    _itemIDNamelImage.font =kNormalTextFont;
    _itemIDNamelImage.text = @"身份证照片: ";
    [imageView addSubview:_itemIDNamelImage];
    
    
    _showBtn =[UIButton buttonWithType:UIButtonTypeCustom];
    _showBtn.frame = CGRectMake(100, 95, 60, 60);
