...
@implementation MyServiceDrivierTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_showBtn setTitle:@"代驾" forState:UIControlStateNormal];
        ...
        UILabel*_delegatLabel  =[[UILabel alloc]initWithFrame:CGRectMake(15, 30+5, 60, 30)];
        ...
        _delegatLabel.text = @"代驾价格: ";
        [self.contentView addSubview:_delegatLabel];
        
        _priceOf  =[[MBLabel alloc]initWithFrame:CGRectMake(70,30+5, kScreenWidth-90, 30)];
        _priceOf.backgroundColor =[UIColor clearColor];
        _priceOf.font =kNormalTextFont;
        [self.contentView addSubview:_priceOf];
        
        UILabel*_delegatLabelTwo  =[[UILabel alloc]initWithFrame:CGRectMake(15, 60+5, 60, 30)];
        ...
        _timeFrom  =[[MBLabel alloc]initWithFrame:CGRectMake(70,60+5, 80, 30)];
        _timeFrom.backgroundColor =[UIColor clearColor];
        _timeFrom.font =kNormalTextFont;
        [self.contentView addSubview:_timeFrom];
        
        
        UILabel*_delegatLabelTwoTo  =[[UILabel alloc]initWithFrame:CGRectMake(170, 60+5, 60, 30)];
        ...
        _timeTo  =[[MBLabel alloc]initWithFrame:CGRectMake(250,60+5, 90, 30)];
        _timeTo.backgroundColor =[UIColor clearColor];
        _timeTo.font =kNormalTextFont;
        [self.contentView addSubview:_timeTo];
        
        
        UILabel*_delegatLabelThree  =[[UILabel alloc]initWithFrame:CGRectMake(15, 90+5, 60, 30)];
        ...
        _fromAdd  =[[MBLabel alloc]initWithFrame:CGRectMake(70,90+5, kScreenWidth-90, 30)];
        _fromAdd.backgroundColor =[UIColor clearColor];
        _fromAdd.font =kNormalTextFont;
        [self.contentView addSubview:_fromAdd];
        
        UILabel*_delegatLabelFour  =[[UILabel alloc]initWithFrame:CGRectMake(15, 120+5, 60, 30)];
        ...
        _toAdd  =[[MBLabel alloc]initWithFrame:CGRectMake(70,120+5, kScreenWidth-90, 30)];
        _toAdd.backgroundColor =[UIColor clearColor];
        _toAdd.font =kNormalTextFont;
        [self.contentView addSubview:_toAdd];
        
        UIImageView *sepectTwo = [[UIImageView alloc]initWithFrame:CGRectMake(10, 151+5, kScreenWidth-20, 1)];
        sepectTwo.backgroundColor =[UIColor grayColor];
        [self.contentView addSubview:sepectTwo];
        
        
        UILabel*_delegatLabelFive  =[[UILabel alloc]initWithFrame:CGRectMake(15, 150+5, 60, 30)];
        ...
        _detail  =[[MBLabel alloc]initWithFrame:CGRectMake(70,180+5, kScreenWidth-90, 30)];
...
- (void)offBtnPressed
{
    if (_delegateAbout&&[_delegateAbout respondsToSelector:@selector(driverCellAboutApplyToVIP:)]) {
        [_delegateAbout driverCellAboutApplyToVIP:self];
    }
}
- (void)vipAppleSele
{
    if (_delegateAbout&&[_delegateAbout respondsToSelector:@selector(putAwayToCell:)]) {
        [_delegateAbout putAwayToCell:self];
    }
}
