...
@implementation MyServicePinCheTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_showBtn setTitle:@"拼车" forState:UIControlStateNormal];
...
- (void)offBtnPressed
{
    if (_delegateAbout&&[_delegateAbout respondsToSelector:@selector(driverCellAboutApplyToVIPAboutPinChe:)]) {
        [_delegateAbout driverCellAboutApplyToVIPAboutPinChe:self];
    }
}
- (void)vipAppleSele
{
    if (_delegateAbout&&[_delegateAbout respondsToSelector:@selector(putAwayToCellAboutPinChe:)]) {
        [_delegateAbout putAwayToCellAboutPinChe:self];
    }
}
