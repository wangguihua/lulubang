...
@interface MySerVicePinCheViewController ()<UITextFieldDelegate>
{
    MBTextField *_nameTF;
...
@implementation MySerVicePinCheViewController
...
-(void)oneBtnPressed{
    ...
    UIImageView *imageViewAbout =[[UIImageView alloc]initWithFrame:CGRectMake(10, 110, kScreenWidth-20, 190)];
    imageViewAbout.layer.borderWidth  = 0.5f;
    imageViewAbout.layer.cornerRadius  = 7.0f;
    imageViewAbout.backgroundColor = [UIColor whiteColor];
    imageViewAbout.layer.borderColor=[UIColor grayColor].CGColor;
    ...
    [UIView animateWithDuration:0.15 animations:^{
        ...
        _imageViewTwo.frame = CGRectMake(_imageViewTwo.frame.origin.x, _imageViewTwo.frame.origin.y+200, _imageViewTwo.frame.size.width, _imageViewTwo.frame.size.height);
        _imageViewThree.frame = CGRectMake(_imageViewThree.frame.origin.x, _imageViewThree.frame.origin.y+200, _imageViewThree.frame.size.width, _imageViewThree.frame.size.height);
        _imageViewLast.frame = CGRectMake(_imageViewLast.frame.origin.x, _imageViewLast.frame.origin.y+200, _imageViewLast.frame.size.width, _imageViewLast.frame.size.height);
